/* Brain2 Console — Agents page data + seed (plain JS on window). */
...
function asst(full, tools, footer, reveal) {
  return { role: 'assistant', tools: tools || [], text: full, footer: footer || null, reveal: (reveal === undefined ? null : reveal) };
}
const CANNED_REPLY = "On it. I pulled the relevant wiki page and its cited sources, cross-checked each claim against them, and flagged anything that isn't directly supported. A short summary and suggested edits are ready for review — tell me if you'd like me to apply them.";
...
Object.assign(window, { AG_PEOPLE, SEED_AGENTS, PICK_MODELS, SEED_TODOS, CANNED_REPLY, asst });
